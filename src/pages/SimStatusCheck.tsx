...
import { Package, Phone, ScanLine, Microchip, AlertCircle, CheckCircle2, AlertTriangle, XCircle } from "lucide-react";
...
const STATUS_ICON: Record<SimStatus, typeof Microchip> = {
  active: CheckCircle2,
  ...
  return (
    <div className="mobile-container min-h-screen bg-background pb-10">
      ...
      <div className="px-4 space-y-4">
        ...
        {record && (
          <CardSection title={t("simStatusCheck.simStatusDetails")} icon={Microchip}>
