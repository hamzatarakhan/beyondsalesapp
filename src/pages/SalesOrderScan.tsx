...
const SalesOrderScan = () => {
  ...
  const submit = () => {
    ...
    // Scanning itself never changes the order's status — that's decided by Submit on the
    // View Order page (Awaiting Delivery if everything ended up fully scanned, Partially
    // Scanned otherwise).
