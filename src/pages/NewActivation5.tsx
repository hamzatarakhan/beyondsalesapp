        ...
        {step === 1 && (
          <>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {t("activation5.subscription.allPlansBtn")}
              ...
              <section className="bg-card rounded-2xl p-4 shadow-sm">
                ...
                {subType === "sim" ? (
                  ...
                  <div className="space-y-3">
                    <Field label={t("activation5.subscription.portNumber")}><PhoneNumberInput value={portNumber} onChange={setPortNumber} /></Field>
        ...
        {step === 2 && (
          <>
            ...
            <section className="bg-card rounded-2xl p-4 shadow-sm">
              ...
              {!isFriendi && <SummaryRow label={t("activation5.subscription.lineTypeTitle")} value={lineType === "data" ? t("activation5.subscription.lineData") : t("activation5.subscription.lineMobile")} />}
            ...
            {!(isWhitelisted && !isVipNumber) && !(isFulfilment && alreadyPaid) && total > 0 && (
              <section className="bg-card rounded-2xl p-4 shadow-sm">
                ...
                <div className="space-y-2">
                  <PayOption icon={CreditCard} label={t("activation5.checkout.dealerWallet")} description={t("activation5.checkout.dealerWalletDesc", { balance: DEALER_WALLET_BALANCE.toFixed(2) })} selected={pay === "card"} disabled={total > DEALER_WALLET_BALANCE} justToppedUp={justToppedUp} onClick={() => setPay("card")}>
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  navigate("/");
                  toast({
                    title: t("activation5.success.shareSuccessTitle"),
                    description: t("activation5.success.shareSuccessDesc", { target: shareValue }),
                  });
                }}
              >
