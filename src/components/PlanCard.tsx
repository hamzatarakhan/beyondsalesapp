...
const SocialChip = ({ onClick }: { onClick: () => void }) => (
  <button onClick={onClick} className="active:opacity-70">
    <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-sky-50 dark:bg-sky-500/10 text-sky-600 text-[10px] font-semibold pointer-events-none">
      <span className="flex -space-x-1">
        <span className="w-3.5 h-3.5 rounded-full bg-[#25D366] border border-card" />
        <span className="w-3.5 h-3.5 rounded-full bg-[#FF0000] border border-card" />
      </span>
      +{AppIcons.length - 2} more <ChevronRight className="w-2.5 h-2.5" />
    </span>
  </button>
);
...
const FlagChip = ({ onClick }: { onClick: () => void }) => (
  <button onClick={onClick} className="active:opacity-70">
    <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-sky-50 dark:bg-sky-500/10 text-sky-600 text-[10px] font-semibold pointer-events-none">
      <span className="flex -space-x-0.5 text-[11px]">🇸🇦🇦🇪</span>
      +{COUNTRIES.length - 2} more <ChevronRight className="w-2.5 h-2.5" />
    </span>
  </button>
);
